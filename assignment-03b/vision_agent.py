...
def run_vision_agent(image_path: str) -> VisionOutput:
    ...
    if not path.exists():
        ...
        return VisionOutput(
            ...
            processing_notes="",
            rejected=True,
            rejection_reason=f"File not found: {image_path}",
        )
    ...
    if media_type is None:
        ...
        return VisionOutput(
            ...
            processing_notes="",
            rejected=True,
            rejection_reason=f"Unsupported file type: .{ext}. Supported: jpg, jpeg, png",
        )
    ...
    if response is None:
        ...
        return VisionOutput(
            ...
            processing_notes="",
            rejected=True,
            rejection_reason=f"API call failed after {MAX_RETRIES} attempts: {last_error}",
        )
    ...
    if response.stop_reason == "tool_use":
        ...
        return VisionOutput(
            ...
            processing_notes="",
            rejected=True,
            rejection_reason="Unexpected tool_use stop_reason from API",
        )
    ...
    try:
        ...
        return VisionOutput(
            ...
            processing_notes="",
            rejected=True,
            rejection_reason=f"JSON parse error: {exc}",
        )
